      ...
      <main className="relative min-h-screen w-full flex flex-col overflow-hidden">
        ...
        <section className="relative flex-grow flex items-center justify-center px-4 md:px-8 lg:px-12" data-testid="hero-section">
          ...
          <div className="relative z-20 w-full max-w-[1800px] mx-auto">
            ...
            <div className="hidden md:grid md:grid-cols-[1fr_minmax(280px,400px)_1fr] lg:grid-cols-[1fr_minmax(320px,450px)_1fr] xl:grid-cols-[1fr_minmax(380px,500px)_1fr] gap-4 lg:gap-8 xl:gap-12 items-center min-h-[80vh]">
              
              {/* Left Content */}
              <div className="flex flex-col justify-center z-30 pr-4 lg:pr-8">
                <div className="space-y-4 lg:space-y-6">
                  <div className="space-y-2 lg:space-y-3">
                    <span className="text-[9px] lg:text-[10px] xl:text-[11px] tracking-widest uppercase text-primary font-semibold">
                      The Cover Story
                    </span>
                    <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-serif italic text-white leading-tight">
                      The Anatomy <br /> of Scale
                    </h2>
                    <p className="text-[9px] lg:text-[10px] xl:text-[11px] tracking-widest uppercase text-slate-400 max-w-[240px] lg:max-w-[280px] xl:max-w-[320px] leading-relaxed">
                      From zero to high-eight figures. The JP methodology revealed.
                    </p>
                  </div>

                  <div className="pt-6 lg:pt-10 xl:pt-12 space-y-3 lg:space-y-4">
                    <span className="text-[9px] lg:text-[10px] xl:text-[11px] tracking-widest uppercase text-primary font-semibold block">
                      The Bottom Line
                    </span>
                    <div className="flex items-baseline gap-2">
                      <span className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-display text-white">₹5Cr<span className="text-primary">+</span></span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="h-px w-6 lg:w-8 bg-slate-600"></div>
                      <span className="text-[8px] lg:text-[9px] xl:text-[10px] tracking-widest uppercase text-slate-400">
              ...
              {/* Right Content */}
              <div className="flex flex-col justify-center z-30 text-right pl-4 lg:pl-8">
                <div className="space-y-6 lg:space-y-10 xl:space-y-12">
                  <div className="space-y-2 inline-block ml-auto">
                    <span className="inline-block bg-primary text-background-dark px-2 lg:px-3 py-1 text-[9px] lg:text-[10px] xl:text-[11px] font-bold tracking-widest uppercase">
                      Issue 042
                    </span>
                    <h3 className="text-[10px] lg:text-xs italic font-serif text-slate-500 mt-2">
                      Global Excellence Report
                    </h3>
                    <p className="text-[8px] lg:text-[9px] tracking-widest text-slate-400">$19.99 // VOL. XII</p>
                  </div>

                  <div className="pt-4 lg:pt-8 xl:pt-12 space-y-3 lg:space-y-4">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-serif italic text-white leading-tight">
                      Precision <br /> & Legacy
                    </h2>
                    <p className="text-[9px] lg:text-[10px] xl:text-[11px] tracking-widest uppercase text-primary italic max-w-[180px] lg:max-w-[220px] xl:max-w-[260px] ml-auto">
                      Architecting the future of enterprise closures.
                    </p>
                    <div className="w-16 lg:w-20 h-px bg-slate-600 ml-auto mt-4 lg:mt-6"></div>
                  </div>
                  ...
                  <div className="pt-4 lg:pt-8 xl:pt-12 space-y-3 lg:space-y-4">
                    ...
                    <div className="flex items-center justify-end">
                      <span className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-display text-white tracking-tighter">
